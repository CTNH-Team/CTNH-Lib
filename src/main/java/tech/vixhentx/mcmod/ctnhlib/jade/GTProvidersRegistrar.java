...
public final class GTProvidersRegistrar {
    ...
    private static void registerBlockDataProviders() {
        ...
        JadePriorityManager.registerBlockData(new MaintenanceBlockProvider(), BlockEntity.class, 1800, "maintenance_data");
        JadePriorityManager.registerBlockData(new ExhaustVentBlockProvider(), BlockEntity.class, 1900, "exhaust_vent_data");
        JadePriorityManager.registerBlockData(new SteamBoilerBlockProvider(), BlockEntity.class, 2000, "steam_boiler_data");
        JadePriorityManager.registerBlockData(new AutoOutputBlockProvider(), BlockEntity.class, 2100, "auto_output_data");
        ...
        JadePriorityManager.registerBlockData(new StainedColorProvider(), BlockEntity.class, 2400, "stained_color_data");
        ...
        if (GTCEu.Mods.isAE2Loaded()) {
            JadePriorityManager.registerBlockData(new MEPatternBufferProvider(), BlockEntity.class, 2900, "me_pattern_buffer_data");
            JadePriorityManager.registerBlockData(new MEPatternBufferProxyProvider(), BlockEntity.class, 3000, "me_pattern_buffer_proxy_data");
        }
    }
    ...
    private static void registerBlockComponentProviders() {
        ...
        JadePriorityManager.registerBlockComponent(new MaintenanceBlockProvider(), Block.class, 1800, "maintenance_component");
        JadePriorityManager.registerBlockComponent(new ExhaustVentBlockProvider(), Block.class, 1900, "exhaust_vent_component");
        JadePriorityManager.registerBlockComponent(new SteamBoilerBlockProvider(), Block.class, 2000, "steam_boiler_component");
        JadePriorityManager.registerBlockComponent(new AutoOutputBlockProvider(), Block.class, 2100, "auto_output_component");
        JadePriorityManager.registerBlockComponent(new CableBlockProvider(), Block.class, 2200, "cable_component");
        JadePriorityManager.registerBlockComponent(new MachineModeProvider(), Block.class, 2300, "machine_mode_component");
        JadePriorityManager.registerBlockComponent(new StainedColorProvider(), Block.class, 2400, "stained_color_component");
        ...
        if (GTCEu.Mods.isAE2Loaded()) {
            JadePriorityManager.registerBlockComponent(new MEPatternBufferProvider(), Block.class, 2900, "me_pattern_buffer_component");
            JadePriorityManager.registerBlockComponent(new MEPatternBufferProxyProvider(), Block.class, 3000, "me_pattern_buffer_proxy_component");
        }
    }
}
