...
public class CTNHItemBuilder<T extends Item, P> extends ItemBuilder<T, P> {
    ...
    protected CTNHItemBuilder(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback,
                              NonNullFunction<Item.Properties, T> factory) {
        super(owner, parent, name, callback, factory);
    }

    public static <T extends Item, P> CTNHItemBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name,
