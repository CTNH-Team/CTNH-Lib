...
public class CTNHBlockBuilder<T extends Block, P> extends GTBlockBuilder<T, P> {
    ...
    protected CTNHBlockBuilder(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback,
    ...
    public static <T extends Block, P> CTNHBlockBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name,
                                                                     ...
                                                                     NonNullFunction<BlockBehaviour.Properties, T> factory) {
        return (CTNHBlockBuilder<T, P>) new CTNHBlockBuilder<>(owner, parent, name, callback, factory,
